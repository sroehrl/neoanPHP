...
app.service('Upload', ['$parse', '$timeout', '$compile', 'UploadResize', function ($parse, $timeout, $compile, UploadResize) {
...
app.service('UploadResize', ['UploadValidate', '$q', '$timeout', function (UploadValidate, $q, $timeout) {
...
(function () {
    app.directive('ngfDrop', ['$parse', '$timeout', '$location', 'Upload', '$http',
