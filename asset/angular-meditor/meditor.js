        ...
        return {
            ...
            link: function (scope, element, attributes, ctrl) {
                ...
                scope.$watch('family', function() {
                    ...
                    console.log(scope.family.value);
                    /* custom event for two-way binding*/
                    scope.$broadcast('meditor-change');
                });
                ...
                /* watch the link type */
                scope.linkr = function() {
                    console.info(scope.target);
                    if(typeof scope.target !== 'undefined' && typeof scope.target.type !== 'undefined' && scope.target.type=='external'){
                        var p = prompt('Target?');
                        if(p){
                            document.execCommand('createLink', false, p);
                        }

                    }
                    if(typeof scope.target !== 'undefined' && typeof scope.target.type !== 'undefined' && scope.target.type=='internal'){
                        document.execCommand('createLink', false, scope.target.url);
                    }
...
/*
angular.module('neoan-meditor').run(['$templateCache', function($templateCache) {
    'use strict';
